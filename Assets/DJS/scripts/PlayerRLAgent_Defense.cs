...
public class PlayerRLAgent_Defense : Agent
{
    ...
    public override void OnActionReceived(ActionBuffers actions)
    {
        ...
        {
            var sr = Unity.MLAgents.Academy.Instance.StatsRecorder;
            sr.Add("Defense/Agent/HP", self.CurHP / self.maxHP, StatAggregationMethod.MostRecent);
            sr.Add("Defense/Agent/GuardCD", self.GuardCD, StatAggregationMethod.MostRecent);
