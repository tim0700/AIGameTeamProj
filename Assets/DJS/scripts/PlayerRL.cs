...
public class PlayerRL : MonoBehaviour
{
    ...
    // public PlayerRL Opponent => opponent; // 읽기 전용 프로퍼티 제공 (선택사항)
    ...
    [Header("개발/테스트용 마우스 설정")] //****이부분 추가
    public bool useMouseLock = false;

    // [SerializeField] private bool isRLAgent = true; // ******기본값 true
